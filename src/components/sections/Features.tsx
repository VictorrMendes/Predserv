      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 text-center divide-y md:divide-y-0 md:divide-x divide-gray-100">
          {featuresList.map((feature, index) => {
            ...
            return (
              <div key={index} className="animate-fade-up p-6" style={{ animationDelay: `${index * 0.12}s` }}>
                <div className={`mx-auto mb-6 flex h-16 w-16 items-center justify-center rounded-full ${index === 1 ? 'bg-teal-50 text-predserv-teal' : 'bg-yellow-50 text-predserv-yellow'}`}>
