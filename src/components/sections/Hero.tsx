...
export default function Hero() {
  return (
    <section className="relative bg-predserv-dark text-white pt-24 pb-36 overflow-hidden">
      ...
      <div className="animate-gradient-pan absolute inset-0 bg-linear-to-r from-predserv-teal/10 via-transparent to-predserv-yellow/10" />
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          ...
          <div className="animate-fade-up" style={{ animationDelay: '0.05s' }}>
            ...
            <div className="animate-fade-up flex flex-col sm:flex-row gap-5" style={{ animationDelay: '0.35s' }}>
              <a href="#servicos" className="hover-glow-strong bg-predserv-teal hover:bg-teal-700 text-white px-8 py-4 rounded-md font-bold text-lg flex items-center justify-center gap-2 shadow-lg transition-colors">
                Conheça Nossos Serviços
              </a>
              <a href={companyInfo.whatsappLink} target="_blank" rel="noreferrer" className="hover-lift bg-transparent border-2 border-white hover:bg-white/10 text-white px-8 py-4 rounded-md font-bold text-lg flex items-center justify-center gap-2 transition-colors">
          ...
          <div className="hidden md:block animate-fade-up" style={{ animationDelay: '0.2s' }}>
            <div className="animate-float-slow bg-white p-10 rounded-2xl shadow-2xl text-predserv-dark max-w-md ml-auto border-t-8 border-predserv-teal relative">
              ...
              <form className="space-y-5">
                ...
                <button type="button" className="hover-glow-strong w-full bg-predserv-yellow hover:bg-yellow-500 text-white px-6 py-4 rounded-lg font-bold text-xl shadow-md transition-colors">
                  Solicitar Contato
                </button>
              </form>
            </div>
